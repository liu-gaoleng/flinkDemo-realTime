...
public class DwdTradeCartAdd extends BaseSQLApp {
    ...
    public void handle(StreamTableEnvironment tableEnv) {
        //TODO 从kafka的topic_DB主题中读取业务数据   创建动态表
        readOdsDb(tableEnv,Constant.TOPIC_DWD_TRADE_CART_ADD);

        //TODO 过滤出加购数据   ---table = ‘cart_info’  type = ‘insert’ / type = ‘update’ 并且修改的字段是购买的数量同时修改后的数量大于修改之前的数量
        ...
        //TODO 将加购数据写到kafka主题中
        //创建动态表和要写入kafka的主题进行映射
