...
public class DwsTradeProvinceOrderWindow extends BaseApp {
    ...
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> kafkaStrDS) {
        //TODO 过滤空消息 并对流中的数据进行类型转换 jsonStr->jsonObj
        ...
        //TODO 指定watermark生成策略并提取事件时间字段
        SingleOutputStreamOperator<JSONObject> withWatermarkDS = distinctDS.assignTimestampsAndWatermarks(WatermarkStrategy
        ...
        //TODO 再次对流中的数据进行类型转换 jsonObj->实体类对象
