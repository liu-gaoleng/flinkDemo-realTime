...
public class DwsTrafficSourceKeywordPageViewWindow extends BaseSQLApp {
    ...
    public void handle(StreamTableEnvironment tableEnv) {
        ...
        //TODO 读取kafka主题页面事实表中的数据 创建动态表 并指定watermark的生成策略和指定事件时间字段
